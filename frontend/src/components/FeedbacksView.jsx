		...
		<div className="py-8 w-full">
			<div className="lg:flex items-center justify-center w-full">
				...
				{feedbacks.map((feedback, index) => (
					<div
						key={index}
						className="lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 bg-purple-100 p-6 shadow rounded border border-black-500"
					>
						<div className="flex items-center border-b border-gray-200 pb-6">
							<img
								src={index === 0 ? conor : index === 1 ? biker : index === 2 ? ironman : chimaev}
								alt="user avatar"
						...
						<div className="px-2">
							<p className="text-sm leading-5 py-4 text-gray-600">{feedback.content}</p>
						</div>
					</div>
				))}
			</div>
